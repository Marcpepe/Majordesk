...
//defining basic operators in Majordesk environnement
define('MATHSCRIPT_OPERATORS', __NAMESPACE__.'\\mathscript_operators');
...
class MathValidator
{
    static $operators =  array
        (
			// $mathscript_operators = __NAMESPACE__.'\\mathscript_operators';
			// $mathscript_operators = 'Majordesk\AppBundle\Service\mathscript_operators';
     ...
     */
    public function __construct($modules = array('basicmath')) 
    {
