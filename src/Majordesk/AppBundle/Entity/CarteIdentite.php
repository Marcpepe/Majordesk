 ...
 * CarteIdentite
 *
 * @ORM\Table(name="carteidentite")
 * @ORM\Entity(repositoryClass="Majordesk\AppBundle\Entity\CarteIdentiteRepository")
...
class CarteIdentite
{
	...
	/**
	 * @ORM\OneToOne(targetEntity="Majordesk\AppBundle\Entity\Professeur", inversedBy="carteIdentite")
	 */
	private $professeur;
